...
public class GameConstants {
    ...
    public static final int CHARACTER_MESSAGE_MEDIUM_SEQUENCE = 5;

    public static final int MAX_NUM_OF_TILES_FOR_SCORE = 7;

    public static final int DROP_BLOCK_INITIAL_PERIOD_IN_SEC = 15;
    public static final int DROP_BLOCK_TIME_BETWEEN_FREQ_CHANGES_IN_SEC = 31;
