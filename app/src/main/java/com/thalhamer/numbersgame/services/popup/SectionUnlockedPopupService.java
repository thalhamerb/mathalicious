...
public class SectionUnlockedPopupService extends AbstractPopupService {
    ...
    public void createSectionUnlockedPopup(final Activity activity, final ViewGroup currentView, GameUnlock gameUnlock) {
        ...
        setTitle(popupView);
        setPowersEarned(activity, gameUnlock, popupView);
    ...
    private void setPowersEarned(Activity activity, GameUnlock gameUnlock, View popupView) {
    ...
    private void setTitle(View popupView) {
